...
description: Critic-side adversarial review of one loop-authored PR — holistic, profile-driven, advisory. Invoked by loop-run rung 5 in a fresh subagent; runnable locally against a PR number.
